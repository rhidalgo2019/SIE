...
public class b4xrh {
    ...
    public static PCBA staticBA = new PCBA(null, b4xrh.class);
...
public static RemoteObject _tbl_rh = RemoteObject.declareNull("b4j.example.flexgrid");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"B_Guardar",_ref.getField(false, "_b_guardar"),"B_Proceder",_ref.getField(false, "_b_proceder"),"B_Regresar",_ref.getField(false, "_b_regresar"),"DateUtils",_ref.getField(false, "_dateutils"),"mRS",_ref.getField(false, "_mrs"),"mSQL",_ref.getField(false, "_msql"),"Root",_ref.getField(false, "_root"),"SP_Anio",_ref.getField(false, "_sp_anio"),"SP_Mes",_ref.getField(false, "_sp_mes"),"TBL_RH",_ref.getField(false, "_tbl_rh"),"xui",_ref.getField(false, "_xui")};
}
}