...
try {
		Debug.PushSubsStack("Clear (b4xbitset) ","b4xbitset",12,__ref.getField(false, "ba"),__ref,53);
...
try {
		Debug.PushSubsStack("Get (b4xbitset) ","b4xbitset",12,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("getSize (b4xbitset) ","b4xbitset",12,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("Initialize (b4xbitset) ","b4xbitset",12,__ref.getField(false, "ba"),__ref,10);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (japam.SIE.b4xbitset.class, "_clear" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Set (b4xbitset) ","b4xbitset",12,__ref.getField(false, "ba"),__ref,16);
