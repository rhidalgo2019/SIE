...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,84);
...
__ref.runClassMethod (japam.SIE.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (japam.SIE.roundslider.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,33);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (japam.SIE.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,154);
if (RapidSub.canDelegate("getvalue")) { return __ref.runUserSub(false, "roundslider","getvalue", __ref);}
 BA.debugLineNum = 154;BA.debugLine="Public Sub getValue As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 155;BA.debugLine="Return mValue";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,114);
...
__ref.setField ("_mvalue" /*RemoteObject*/ ,_newvalue);
 BA.debugLineNum = 127;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Valu";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_ValueChanged"))),(Object)(BA.numberCast(int.class, 1))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 128;BA.debugLine="CallSub2(mCallBack, mEventName & \"_ValueChange";
Debug.JustUpdateDeviceLine();
roundslider.__c.runMethodAndSync(false,"CallSubNew2",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_ValueChanged"))),(Object)((__ref.getField(true,"_mvalue" /*RemoteObject*/ ))));
 ...
 BA.debugLineNum = 131;BA.debugLine="Draw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (japam.SIE.roundslider.class, "_draw" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("SetCircleColor (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("SetThumbColor (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",44,__ref.getField(false, "ba"),__ref,149);
if (RapidSub.canDelegate("setvalue")) { return __ref.runUserSub(false, "roundslider","setvalue", __ref, _v);}
Debug.locals.put("v", _v);
 BA.debugLineNum = 149;BA.debugLine="Public Sub setValue (v As Int)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 150;BA.debugLine="mValue = Max(mMin, Min(mMax, v))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mvalue" /*RemoteObject*/ ,BA.numberCast(int.class, roundslider.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, __ref.getField(true,"_mmin" /*RemoteObject*/ ))),(Object)(roundslider.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, __ref.getField(true,"_mmax" /*RemoteObject*/ ))),(Object)(BA.numberCast(double.class, _v)))))));
 BA.debugLineNum = 151;BA.debugLine="Draw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (japam.SIE.roundslider.class, "_draw" /*RemoteObject*/ );
