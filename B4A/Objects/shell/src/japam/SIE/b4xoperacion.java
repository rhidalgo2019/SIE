...
public class b4xoperacion {
    public static RemoteObject myClass;
	public b4xoperacion() {
	}
    public static PCBA staticBA = new PCBA(null, b4xoperacion.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _root = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _xui = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");
public static RemoteObject _tbl_pozos = RemoteObject.declareNull("b4j.example.flexgrid");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"B_Guardar",_ref.getField(false, "_b_guardar"),"B_Proceder",_ref.getField(false, "_b_proceder"),"B_Regresar",_ref.getField(false, "_b_regresar"),"DateUtils",_ref.getField(false, "_dateutils"),"mRS",_ref.getField(false, "_mrs"),"mSQL",_ref.getField(false, "_msql"),"Root",_ref.getField(false, "_root"),"SP_Anio",_ref.getField(false, "_sp_anio"),"SP_Mes",_ref.getField(false, "_sp_mes"),"TBL_Pozos",_ref.getField(false, "_tbl_pozos"),"xui",_ref.getField(false, "_xui")};
}
}