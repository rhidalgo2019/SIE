...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "japam.SIE", "japam.SIE.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "japam.SIE", "japam.SIE.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "japam.SIE.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static anywheresoftware.b4a.sql.SQL _msql = null;
public static anywheresoftware.b4a.sql.SQL _msql2 = null;
public static anywheresoftware.b4a.sql.SQL.ResultSetWrapper _mrs = null;
public static anywheresoftware.b4a.sql.SQL.ResultSetWrapper _mrs2 = null;
...
RDebugUtils.currentLine=35782656;
 //BA.debugLineNum = 35782656;BA.debugLine="Sub Activity_ActionBarHomeClick";
RDebugUtils.currentLine=35782657;
 //BA.debugLineNum = 35782657;BA.debugLine="ActionBarHomeClicked = True";
_actionbarhomeclicked = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=35782658;
 //BA.debugLineNum = 35782658;BA.debugLine="B4XPages.Delegate.Activity_ActionBarHomeClick";
mostCurrent._b4xpages._delegate /*japam.SIE.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ (null);
RDebugUtils.currentLine=35782659;
 //BA.debugLineNum = 35782659;BA.debugLine="ActionBarHomeClicked = False";
...
RDebugUtils.currentLine=35848192;
 //BA.debugLineNum = 35848192;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
RDebugUtils.currentLine=35848193;
 //BA.debugLineNum = 35848193;BA.debugLine="Return B4XPages.Delegate.Activity_KeyPress(KeyCod";
if (true) return mostCurrent._b4xpages._delegate /*japam.SIE.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (null,_keycode);
...
mostCurrent._b4xpages._delegate /*japam.SIE.b4xpagesdelegator*/ ._activity_pause /*String*/ (null);
...
RDebugUtils.currentLine=35913728;
 //BA.debugLineNum = 35913728;BA.debugLine="Sub Activity_PermissionResult (Permission As Strin";
RDebugUtils.currentLine=35913729;
 //BA.debugLineNum = 35913729;BA.debugLine="B4XPages.Delegate.Activity_PermissionResult(Permi";
mostCurrent._b4xpages._delegate /*japam.SIE.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (null,_permission,_result);
...
mostCurrent._b4xpages._delegate /*japam.SIE.b4xpagesdelegator*/ ._activity_resume /*String*/ (null);
...
RDebugUtils.currentLine=35979264;
 //BA.debugLineNum = 35979264;BA.debugLine="Sub Create_Menu (Menu As Object)";
RDebugUtils.currentLine=35979265;
 //BA.debugLineNum = 35979265;BA.debugLine="B4XPages.Delegate.Create_Menu(Menu)";
mostCurrent._b4xpages._delegate /*japam.SIE.b4xpagesdelegator*/ ._create_menu /*String*/ (null,_menu);
