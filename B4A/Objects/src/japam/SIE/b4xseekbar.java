...
public class b4xseekbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "japam.SIE.b4xseekbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", japam.SIE.b4xseekbar.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(japam.SIE.b4xseekbar __ref,double _width,double _height) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "base_resize", true))
	 {return ((String) Debug.delegate(ba, "base_resize", new Object[] {_width,_height}));}
RDebugUtils.currentLine=30736384;
 //BA.debugLineNum = 30736384;BA.debugLine="Private Sub Base_Resize (Width As Double, Height A";
RDebugUtils.currentLine=30736385;
 //BA.debugLineNum = 30736385;BA.debugLine="cvs.Resize(Width, Height)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Resize((float) (_width),(float) (_height));
RDebugUtils.currentLine=30736386;
 //BA.debugLineNum = 30736386;BA.debugLine="TouchPanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
RDebugUtils.currentLine=30736387;
 //BA.debugLineNum = 30736387;BA.debugLine="Vertical = mBase.Height > mBase.Width";
__ref._vertical /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()>__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth();
RDebugUtils.currentLine=30736388;
 //BA.debugLineNum = 30736388;BA.debugLine="size = Max(mBase.Height, mBase.Width) - 2 * Radiu";
...
RDebugUtils.currentLine=30736389;
 //BA.debugLineNum = 30736389;BA.debugLine="Update";
__ref._update /*String*/ (null);
RDebugUtils.currentLine=30736390;
 //BA.debugLineNum = 30736390;BA.debugLine="End Sub";
return "";
}
public String  _update(japam.SIE.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=30801920;
 //BA.debugLineNum = 30801920;BA.debugLine="Public Sub Update";
RDebugUtils.currentLine=30801922;
 //BA.debugLineNum = 30801922;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
RDebugUtils.currentLine=30801923;
 //BA.debugLineNum = 30801923;BA.debugLine="If size > 0 Then";
if (__ref._size /*int*/ >0) { 
RDebugUtils.currentLine=30801924;
 //BA.debugLineNum = 30801924;BA.debugLine="If Vertical = False Then";
if (__ref._vertical /*boolean*/ ==__c.False) { 
RDebugUtils.currentLine=30801925;
 //BA.debugLineNum = 30801925;BA.debugLine="Dim s1 As Int = Radius2 + (mValue - MinValue) /";
...
RDebugUtils.currentLine=30801926;
 //BA.debugLineNum = 30801926;BA.debugLine="Dim y As Int = mBase.Height / 2";
_y = (int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)2);
RDebugUtils.currentLine=30801927;
 //BA.debugLineNum = 30801927;BA.debugLine="cvs.DrawLine(Radius2, y, s1, y, Color1, Size1)";
...
RDebugUtils.currentLine=30801928;
 //BA.debugLineNum = 30801928;BA.debugLine="cvs.DrawLine(s1, y, mBase.Width - Radius2, y, C";
...
RDebugUtils.currentLine=30801929;
 //BA.debugLineNum = 30801929;BA.debugLine="cvs.DrawCircle(s1, y, Radius1, Color1, True, 0)";
...
RDebugUtils.currentLine=30801930;
 //BA.debugLineNum = 30801930;BA.debugLine="If Pressed Then";
if (__ref._pressed /*boolean*/ ) { 
RDebugUtils.currentLine=30801931;
 //BA.debugLineNum = 30801931;BA.debugLine="cvs.DrawCircle(s1, y, Radius2, ThumbColor, Tru";
...
RDebugUtils.currentLine=30801934;
 //BA.debugLineNum = 30801934;BA.debugLine="Dim s1 As Int = Radius2 + (MaxValue - mValue -";
...
RDebugUtils.currentLine=30801935;
 //BA.debugLineNum = 30801935;BA.debugLine="Dim x As Int = mBase.Width / 2";
_x = (int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()/(double)2);
RDebugUtils.currentLine=30801936;
 //BA.debugLineNum = 30801936;BA.debugLine="cvs.DrawLine(x, Radius2, x, s1, Color2, Size2)";
...
RDebugUtils.currentLine=30801937;
 //BA.debugLineNum = 30801937;BA.debugLine="cvs.DrawLine(x, s1, x, mBase.Height - Radius2,";
...
RDebugUtils.currentLine=30801938;
 //BA.debugLineNum = 30801938;BA.debugLine="cvs.DrawCircle(x, s1, Radius1, Color1, True, 0)";
...
RDebugUtils.currentLine=30801939;
 //BA.debugLineNum = 30801939;BA.debugLine="If Pressed Then";
if (__ref._pressed /*boolean*/ ) { 
RDebugUtils.currentLine=30801940;
 //BA.debugLineNum = 30801940;BA.debugLine="cvs.DrawCircle(x, s1, Radius2, ThumbColor, Tru";
...
RDebugUtils.currentLine=30801944;
 //BA.debugLineNum = 30801944;BA.debugLine="cvs.Invalidate";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Invalidate();
RDebugUtils.currentLine=30801945;
 //BA.debugLineNum = 30801945;BA.debugLine="End Sub";
return "";
}
public String  _class_globals(japam.SIE.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=30539779;
 //BA.debugLineNum = 30539779;BA.debugLine="Public mBase As B4XView 'ignore";
_mbase = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=30539780;
 //BA.debugLineNum = 30539780;BA.debugLine="Private xui As XUI 'ignore";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
RDebugUtils.currentLine=30539781;
 //BA.debugLineNum = 30539781;BA.debugLine="Public Color1, Color2, ThumbColor As Int";
_color1 = 0;
_color2 = 0;
_thumbcolor = 0;
RDebugUtils.currentLine=30539782;
 //BA.debugLineNum = 30539782;BA.debugLine="Private cvs As B4XCanvas";
_cvs = new anywheresoftware.b4a.objects.B4XCanvas();
RDebugUtils.currentLine=30539783;
 //BA.debugLineNum = 30539783;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=30539784;
 //BA.debugLineNum = 30539784;BA.debugLine="Private TouchPanel As B4XView";
_touchpanel = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=30539785;
 //BA.debugLineNum = 30539785;BA.debugLine="Private mValue As Int";
_mvalue = 0;
RDebugUtils.currentLine=30539786;
 //BA.debugLineNum = 30539786;BA.debugLine="Public MinValue, MaxValue As Int";
_minvalue = 0;
_maxvalue = 0;
RDebugUtils.currentLine=30539787;
 //BA.debugLineNum = 30539787;BA.debugLine="Public Interval As Int = 1";
_interval = (int) (1);
RDebugUtils.currentLine=30539788;
 //BA.debugLineNum = 30539788;BA.debugLine="Private Vertical As Boolean";
_vertical = false;
RDebugUtils.currentLine=30539789;
 //BA.debugLineNum = 30539789;BA.debugLine="Public Size1 = 4dip, Size2 = 2dip, Radius1 = 6dip";
...
RDebugUtils.currentLine=30539790;
 //BA.debugLineNum = 30539790;BA.debugLine="Private Pressed As Boolean";
_pressed = false;
RDebugUtils.currentLine=30539791;
 //BA.debugLineNum = 30539791;BA.debugLine="Private size As Int";
_size = 0;
RDebugUtils.currentLine=30539792;
 //BA.debugLineNum = 30539792;BA.debugLine="End Sub";
return "";
}
public String  _designercreateview(japam.SIE.b4xseekbar __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "designercreateview", true))
	 {return ((String) Debug.delegate(ba, "designercreateview", new Object[] {_base,_lbl,_props}));}
RDebugUtils.currentLine=30670848;
 //BA.debugLineNum = 30670848;BA.debugLine="Public Sub DesignerCreateView (Base As Object, Lbl";
...
RDebugUtils.currentLine=30670850;
 //BA.debugLineNum = 30670850;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._tag /*Object*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getTag();
RDebugUtils.currentLine=30670850;
 //BA.debugLineNum = 30670850;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setTag(this);
RDebugUtils.currentLine=30670851;
 //BA.debugLineNum = 30670851;BA.debugLine="Color1 = xui.PaintOrColorToColor(Props.Get(\"Color";
...
RDebugUtils.currentLine=30670852;
 //BA.debugLineNum = 30670852;BA.debugLine="Color2 = xui.PaintOrColorToColor(Props.Get(\"Color";
...
RDebugUtils.currentLine=30670853;
 //BA.debugLineNum = 30670853;BA.debugLine="ThumbColor = xui.PaintOrColorToColor(Props.Get(\"T";
...
RDebugUtils.currentLine=30670854;
 //BA.debugLineNum = 30670854;BA.debugLine="Interval = Max(1, Props.GetDefault(\"Interval\", 1)";
...
RDebugUtils.currentLine=30670855;
 //BA.debugLineNum = 30670855;BA.debugLine="MinValue = Props.Get(\"Min\")";
__ref._minvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Min"))));
RDebugUtils.currentLine=30670856;
 //BA.debugLineNum = 30670856;BA.debugLine="MaxValue = Props.Get(\"Max\")";
__ref._maxvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Max"))));
RDebugUtils.currentLine=30670857;
 //BA.debugLineNum = 30670857;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, Props.Get(\"V";
...
RDebugUtils.currentLine=30670858;
 //BA.debugLineNum = 30670858;BA.debugLine="cvs.Initialize(mBase)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Initialize(__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
RDebugUtils.currentLine=30670859;
 //BA.debugLineNum = 30670859;BA.debugLine="TouchPanel = xui.CreatePanel(\"TouchPanel\")";
...
RDebugUtils.currentLine=30670860;
 //BA.debugLineNum = 30670860;BA.debugLine="mBase.AddView(TouchPanel, 0, 0, mBase.Width, mBas";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .AddView((android.view.View)(__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(int) (0),(int) (0),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());
RDebugUtils.currentLine=30670861;
 //BA.debugLineNum = 30670861;BA.debugLine="If xui.IsB4A Or xui.IsB4i Then Radius2 = 20dip";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4A() || __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4i()) { 
__ref._radius2 /*int*/  = __c.DipToCurrent((int) (20));};
RDebugUtils.currentLine=30670862;
 //BA.debugLineNum = 30670862;BA.debugLine="If xui.IsB4A Then Base_Resize(mBase.Width, mBase.";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4A()) { 
__ref._base_resize /*String*/ (null,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());};
RDebugUtils.currentLine=30670863;
 //BA.debugLineNum = 30670863;BA.debugLine="End Sub";
return "";
}
public int  _getvalue(japam.SIE.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
if (Debug.shouldDelegate(ba, "getvalue", true))
	 {return ((Integer) Debug.delegate(ba, "getvalue", null));}
RDebugUtils.currentLine=31129600;
 //BA.debugLineNum = 31129600;BA.debugLine="Public Sub getValue As Int";
RDebugUtils.currentLine=31129601;
 //BA.debugLineNum = 31129601;BA.debugLine="Return mValue";
if (true) return __ref._mvalue /*int*/ ;
RDebugUtils.currentLine=31129602;
 //BA.debugLineNum = 31129602;BA.debugLine="End Sub";
return 0;
}
public String  _initialize(japam.SIE.b4xseekbar __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xseekbar";
...
public String  _raisetouchstateevent(japam.SIE.b4xseekbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=30932992;
 //BA.debugLineNum = 30932992;BA.debugLine="Private Sub RaiseTouchStateEvent";
RDebugUtils.currentLine=30932993;
 //BA.debugLineNum = 30932993;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_TouchS";
...
RDebugUtils.currentLine=30932994;
 //BA.debugLineNum = 30932994;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_TouchS";
...
public String  _setvalue(japam.SIE.b4xseekbar __ref,int _v) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=31064065;
 //BA.debugLineNum = 31064065;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, v))";
__ref._mvalue /*int*/  = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=31064066;
 //BA.debugLineNum = 31064066;BA.debugLine="Update";
__ref._update /*String*/ (null);
RDebugUtils.currentLine=31064067;
 //BA.debugLineNum = 31064067;BA.debugLine="End Sub";
return "";
}
public String  _setvaluebasedontouch(japam.SIE.b4xseekbar __ref,int _x,int _y) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=30998528;
 //BA.debugLineNum = 30998528;BA.debugLine="Private Sub SetValueBasedOnTouch(x As Int, y As In";
RDebugUtils.currentLine=30998529;
 //BA.debugLineNum = 30998529;BA.debugLine="Dim v As Int";
_v = 0;
RDebugUtils.currentLine=30998530;
 //BA.debugLineNum = 30998530;BA.debugLine="If Vertical Then";
if (__ref._vertical /*boolean*/ ) { 
RDebugUtils.currentLine=30998531;
 //BA.debugLineNum = 30998531;BA.debugLine="v = (mBase.Height - Radius2 - y) / size * (MaxVa";
...
RDebugUtils.currentLine=30998533;
 //BA.debugLineNum = 30998533;BA.debugLine="v = (x - Radius2) / size * (MaxValue - MinValue)";
...
RDebugUtils.currentLine=30998535;
 //BA.debugLineNum = 30998535;BA.debugLine="v = Round (v / Interval) * Interval";
_v = (int) (__c.Round(_v/(double)__ref._interval /*int*/ )*__ref._interval /*int*/ );
RDebugUtils.currentLine=30998536;
 //BA.debugLineNum = 30998536;BA.debugLine="Dim NewValue As Int = Max(MinValue, Min(MaxValue,";
_newvalue = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=30998537;
 //BA.debugLineNum = 30998537;BA.debugLine="If NewValue <> mValue Then";
if (_newvalue!=__ref._mvalue /*int*/ ) { 
RDebugUtils.currentLine=30998538;
 //BA.debugLineNum = 30998538;BA.debugLine="mValue = NewValue";
__ref._mvalue /*int*/  = _newvalue;
RDebugUtils.currentLine=30998539;
 //BA.debugLineNum = 30998539;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Value";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .SubExists(ba,__ref._mcallback /*Object*/ ,__ref._meventname /*String*/ +"_ValueChanged",(int) (1))) { 
RDebugUtils.currentLine=30998540;
 //BA.debugLineNum = 30998540;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Value";
...
public String  _touchpanel_touch(japam.SIE.b4xseekbar __ref,int _action,float _x,float _y) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xseekbar";
...
RDebugUtils.currentLine=30867456;
 //BA.debugLineNum = 30867456;BA.debugLine="Private Sub TouchPanel_Touch (Action As Int, X As";
RDebugUtils.currentLine=30867457;
 //BA.debugLineNum = 30867457;BA.debugLine="If Action = TouchPanel.TOUCH_ACTION_DOWN Then";
...
RDebugUtils.currentLine=30867458;
 //BA.debugLineNum = 30867458;BA.debugLine="Pressed = True";
__ref._pressed /*boolean*/  = __c.True;
RDebugUtils.currentLine=30867459;
 //BA.debugLineNum = 30867459;BA.debugLine="RaiseTouchStateEvent";
__ref._raisetouchstateevent /*String*/ (null);
RDebugUtils.currentLine=30867460;
 //BA.debugLineNum = 30867460;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=30867461;
 //BA.debugLineNum = 30867461;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_MOVE The";
...
RDebugUtils.currentLine=30867462;
 //BA.debugLineNum = 30867462;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=30867463;
 //BA.debugLineNum = 30867463;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_UP Then";
if (_action==__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .TOUCH_ACTION_UP) { 
RDebugUtils.currentLine=30867464;
 //BA.debugLineNum = 30867464;BA.debugLine="Pressed = False";
__ref._pressed /*boolean*/  = __c.False;
RDebugUtils.currentLine=30867465;
 //BA.debugLineNum = 30867465;BA.debugLine="RaiseTouchStateEvent";
__ref._raisetouchstateevent /*String*/ (null);
 }}}
;
RDebugUtils.currentLine=30867467;
 //BA.debugLineNum = 30867467;BA.debugLine="Update";
__ref._update /*String*/ (null);
