...
Private Sub B4XPage_Created (Root1 As B4XView)
	...
	TBL_Contabilidad.ColsName=Array As String("Concepto", "Valor")
	TBL_Contabilidad.ColsWidth=Array As Int(630dip, 160dip)
	TBL_Contabilidad.ColsType=Array As Int(TBL_Contabilidad.TypeString, TBL_Contabilidad.TypeString)
	TBL_Contabilidad.ColsAlignment=Array As String("CENTER", "CENTER")
