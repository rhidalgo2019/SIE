...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xpagesdelegator", this);
            if (htSubs == null) {
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._activity_pause /*String*/ ();
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._activity_resume /*String*/ ();
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._mainform_closed /*String*/ ();
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._mainform_closerequest /*String*/ (_eventdata);
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._mainform_focuschanged /*String*/ (_hasfocus);
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._mainform_iconifiedchanged /*String*/ (_iconified);
...
_b4xpages._getmanager /*japam.sie.b4xpagesmanager*/ ()._mainform_resize /*String*/ (_width,_height);
