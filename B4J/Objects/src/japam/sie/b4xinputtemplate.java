...
public class b4xinputtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xinputtemplate", this);
            if (htSubs == null) {
...
public ResumableSub_Show(japam.sie.b4xinputtemplate parent,japam.sie.b4xdialog _dialog) {
this.parent = parent;
