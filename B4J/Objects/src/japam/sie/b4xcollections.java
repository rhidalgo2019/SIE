...
public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xcollections", null);
		ba.loadHtSubs(b4xcollections.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "japam.sie.b4xcollections", ba);
		}
	}
...
public static japam.sie.b4xbitset  _createbitset(int _size) throws Exception{
...
public static japam.sie.b4xorderedmap  _createorderedmap() throws Exception{
...
public static japam.sie.b4xorderedmap  _createorderedmap2(anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
...
public static japam.sie.b4xset  _createset() throws Exception{
...
public static japam.sie.b4xset  _createset2(anywheresoftware.b4a.objects.collections.List _values) throws Exception{
