...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xcolortemplate", this);
            if (htSubs == null) {
...
public japam.sie.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
japam.sie.b4xcolortemplate._colorpickerpart _cpp = null;
...
public String  _drawcheckers(japam.sie.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public ResumableSub_Show(japam.sie.b4xcolortemplate parent,japam.sie.b4xdialog _dialog) {
this.parent = parent;
