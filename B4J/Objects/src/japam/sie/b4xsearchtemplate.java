...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xsearchtemplate", this);
            if (htSubs == null) {
...
japam.sie.b4jtextflow _tf = null;
int _i = 0;
String _item = "";
int _x = 0;
int _pnlcolor = 0;
...
_tf._reset /*japam.sie.b4jtextflow*/ ();
...
_tf._append /*japam.sie.b4jtextflow*/ (_item.substring((int) (0),_x))._setcolor /*japam.sie.b4jtextflow*/ (_customlistview1._defaulttextcolor);
 };
...
_tf._append /*japam.sie.b4jtextflow*/ (_item.substring(_x,(int) (_x+_full.length())))._setcolor /*japam.sie.b4jtextflow*/ (_texthighlightcolor);
 };
...
_tf._append /*japam.sie.b4jtextflow*/ (_item.substring((int) (_x+_full.length())))._setcolor /*japam.sie.b4jtextflow*/ (_customlistview1._defaulttextcolor);
 };
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(japam.sie.b4xdialog _dialog) throws Exception{
...
__c.LogImpl("936831263","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public void  _show(japam.sie.b4xdialog _dialog) throws Exception{
ResumableSub_Show rsub = new ResumableSub_Show(this,_dialog);
rsub.resume(ba, null);
}
public static class ResumableSub_Show extends BA.ResumableSub {
public ResumableSub_Show(japam.sie.b4xsearchtemplate parent,japam.sie.b4xdialog _dialog) {
this.parent = parent;
...
if (BA.fastSubCompare(sub, "GETPANEL"))
	return _getpanel((japam.sie.b4xdialog) args[0]);
