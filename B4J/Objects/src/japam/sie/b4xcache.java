...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xcache", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", japam.sie.b4xcache.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public japam.sie.b4xorderedmap _data = null;
...
_data = new japam.sie.b4xorderedmap();
...
public japam.sie.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
japam.sie.b4xcache._b4xcacheitem _t1 = null;
...
_t1 = new japam.sie.b4xcache._b4xcacheitem();
...
japam.sie.b4xcache._b4xcacheitem _ci = null;
...
_ci = (japam.sie.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_ci = (japam.sie.b4xcache._b4xcacheitem)(group3.Get(index3));
...
_data._remove /*String*/ ((Object)(((japam.sie.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
