...
public class b4xfinanciera extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xfinanciera", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", japam.sie.b4xfinanciera.class).invoke(this, new Object[] {null});
        else
...
public b4j.example.flexgrid _tbl_financiera = null;
...
for (;_x <= limit8 ;_x = _x + step8 ) {
 //BA.debugLineNum = 165;BA.debugLine="mDATOS(x) = TBL_Financiera.GetCellValue(x, 0)";
_mdatos[_x] = BA.ObjectToString(_tbl_financiera._getcellvalue(_x,(int) (0)));
 //BA.debugLineNum = 166;BA.debugLine="mEXTRAIDOS(x) = Main.mFORMATO(TBL_Financiera.G";
_mextraidos[_x] = BA.ObjectToString(_main._mformato /*Object*/ (BA.ObjectToString(_tbl_financiera._getcellvalue(_x,(int) (1))),"T"));
 //BA.debugLineNum = 167;BA.debugLine="Log(mDATOS(x) & \"- \" & mEXTRAIDOS(x) & \" - \" & Mai";
__c.LogImpl("558785816",_mdatos[_x]+"- "+_mextraidos[_x]+" - "+BA.NumberToString(_main._manio /*int*/ ),0);
...
_x = 0;
 //BA.debugLineNum = 22;BA.debugLine="Log(\"B4XFinanciera\")";
__c.LogImpl("558327043","B4XFinanciera",0);
 //BA.debugLineNum = 23;BA.debugLine="Root = Root1";
_root = _root1;
 //BA.debugLineNum = 24;BA.debugLine="Root.LoadLayout(\"Financiera\")";
_root.LoadLayout("Financiera",ba);
 //BA.debugLineNum = 25;BA.debugLine="TBL_Financiera.ColsName=Array As String(\"Concepto";
_tbl_financiera._setcolsname(new String[]{"Concepto","Valor"});
 //BA.debugLineNum = 26;BA.debugLine="TBL_Financiera.ColsWidth=Array As Int(630dip, 160";
_tbl_financiera._setcolswidth(new int[]{__c.DipToCurrent((int) (630)),__c.DipToCurrent((int) (160))});
 //BA.debugLineNum = 27;BA.debugLine="TBL_Financiera.ColsType=Array As Int(TBL_Financie";
_tbl_financiera._setcolstype(new int[]{_tbl_financiera._typestring,_tbl_financiera._typestring});
 //BA.debugLineNum = 28;BA.debugLine="TBL_Financiera.ColsAlignment=Array As String(\"CEN";
_tbl_financiera._setcolsalignment(new String[]{"CENTER","CENTER"});
 //BA.debugLineNum = 29;BA.debugLine="TBL_Financiera.SetColCustomize(0, xui.Color_RGB(0";
_tbl_financiera._setcolcustomize((int) (0),_xui.Color_RGB((int) (0),(int) (0),(int) (255)),_xui.Color_RGB((int) (224),(int) (255),(int) (255)),_xui.CreateDefaultFont((float) (14)));
 //BA.debugLineNum = 30;BA.debugLine="TBL_Financiera.SetColCustomize(1, xui.Color_RGB(0";
_tbl_financiera._setcolcustomize((int) (1),_xui.Color_RGB((int) (0),(int) (0),(int) (255)),_xui.Color_RGB((int) (224),(int) (255),(int) (255)),_xui.CreateDefaultFont((float) (14)));
 //BA.debugLineNum = 31;BA.debugLine="TBL_Financiera.SetColCustomize(2, xui.Color_RGB(0";
_tbl_financiera._setcolcustomize((int) (2),_xui.Color_RGB((int) (0),(int) (0),(int) (255)),_xui.Color_RGB((int) (224),(int) (255),(int) (255)),_xui.CreateDefaultFont((float) (14)));
...
_mes = _main._mmes /*int*/ ;
 //BA.debugLineNum = 66;BA.debugLine="TBL_Financiera.ClearRows";
_tbl_financiera._clearrows();
...
_mrs = _main._msql /*anywheresoftware.b4j.objects.SQL*/ .ExecQuery("SELECT * FROM sie_valores WHERE val_derecho = 6 AND val_anio = "+BA.NumberToString(_anio));
...
_mcadena = BA.ObjectToString(_main._mformato /*Object*/ ((_mvalores[_x]),"N"));
 ...
 //BA.debugLineNum = 111;BA.debugLine="TBL_Financiera.AddRow(Array As Object(mDATOS(x)";
_tbl_financiera._addrow(new Object[]{(Object)(_mdatos[_x]),(Object)(_mcadena)},__c.True);
 }
};
...
__c.LogImpl("558589243","---------- SIE Database (MSSQL)  Fallo de conexion ----------",0);
...
_b_proceder = new anywheresoftware.b4j.objects.ButtonWrapper();
 //BA.debugLineNum = 8;BA.debugLine="Private TBL_Financiera As FlexGrid";
_tbl_financiera = new b4j.example.flexgrid();
...
public String  _tbl_financiera_cellclick(int _row,int _col) throws Exception{
int _mvalor = 0;
 //BA.debugLineNum = 121;BA.debugLine="Private Sub TBL_Financiera_CellClick(Row As Int, C";
 //BA.debugLineNum = 122;BA.debugLine="Dim mVALOR As Int";
_mvalor = 0;
 //BA.debugLineNum = 124;BA.debugLine="If Col >= 1 Then";
if (_col>=1) { 
 //BA.debugLineNum = 125;BA.debugLine="mVALOR = Main.mFORMATO(TBL_Financiera.GetCellVal";
_mvalor = ((int)(BA.ObjectToNumber(_main._mformato /*Object*/ (BA.ObjectToString(_tbl_financiera._getcellvalue(_row,_col)),"T"))));
 //BA.debugLineNum = 126;BA.debugLine="If mVALOR = 0 Or Main.mDERECHO = 99 Then";
if (_mvalor==0 || _main._mderecho /*int*/ ==99) { 
 //BA.debugLineNum = 127;BA.debugLine="TBL_Financiera.EditCellonsite(Row, Col)";
_tbl_financiera._editcellonsite(_row,_col);
 };
 };
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return "";
}
public String  _tbl_financiera_modified(int _row,int _col) throws Exception{
String _mcadena = "";
 //BA.debugLineNum = 132;BA.debugLine="Private Sub TBL_Financiera_Modified(Row As Int, Co";
 //BA.debugLineNum = 133;BA.debugLine="Dim mCADENA As String";
_mcadena = "";
 //BA.debugLineNum = 135;BA.debugLine="If Row < 2 Then";
if (_row<2) { 
 //BA.debugLineNum = 136;BA.debugLine="mCADENA = Main.mFORMATO(TBL_Financiera.GetCellVa";
_mcadena = BA.ObjectToString(_main._mformato /*Object*/ (BA.ObjectToString(_tbl_financiera._getcellvalue(_row,_col)),"M"));
 }else {
 //BA.debugLineNum = 138;BA.debugLine="mCADENA = Main.mFORMATO(TBL_Financiera.GetCellVa";
_mcadena = BA.ObjectToString(_main._mformato /*Object*/ (BA.ObjectToString(_tbl_financiera._getcellvalue(_row,_col)),"N"));
 };
 //BA.debugLineNum = 140;BA.debugLine="TBL_Financiera.SetCellValue(Row, Col, mCADENA)";
_tbl_financiera._setcellvalue(_row,_col,(Object)(_mcadena));
