...
public class b4xtable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xtable", this);
            if (htSubs == null) {
...
public japam.sie.b4jtextflow _textflow = null;
...
public japam.sie.b4xtable._b4xtablecolumn  _addcolumn(String _title,int _columntype) throws Exception{
...
_c.Formatter /*japam.sie.b4xformatter*/  = _defaultdataformatter;
...
public String  _addcolumntoclv(japam.sie.b4xtable._b4xtablecolumn _c) throws Exception{
...
public ResumableSub_CellClicked(japam.sie.b4xtable parent,anywheresoftware.b4a.objects.B4XViewWrapper _pnl,boolean _longclicked) {
this.parent = parent;
this._pnl = _pnl;
...
public String  _checkandremovecolumnthatwasaddedtoincorrectparent(japam.sie.b4xtable._b4xtablecolumn _c,boolean _isfrozen) throws Exception{
...
_textflow = new japam.sie.b4jtextflow();
...
public ResumableSub_Clear(japam.sie.b4xtable parent) {
this.parent = parent;
}
japam.sie.b4xtable parent;
...
parent.__c.LogImpl("915007764","closing old db.",0);
...
public String  _columntosqltype(japam.sie.b4xtable._b4xtablecolumn _c) throws Exception{
...
public String  _createcolumnlayouts(japam.sie.b4xtable._b4xtablecolumn _c,int _size) throws Exception{
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public ResumableSub_DesignerCreateView(japam.sie.b4xtable parent,Object _base,anywheresoftware.b4j.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) {
this.parent = parent;
this._base = _base;
this._lbl = _lbl;
this._props = _props;
...
public japam.sie.b4xtable._b4xtablecolumn  _getcolumn(String _columnid) throws Exception{
japam.sie.b4xtable._b4xtablecolumn _c = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getlabelfromcolumn(japam.sie.b4xtable._b4xtablecolumn _c,int _index) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public String  _headerclicked(japam.sie.b4xtable._b4xtablecolumn _col) throws Exception{
japam.sie.b4xtable._b4xtablecolumn _c = null;
...
public ResumableSub_ImplUpdateDataFromQuery(japam.sie.b4xtable parent,String _query,Object _args,int _totalcount,boolean _dontsleep) {
this.parent = parent;
this._query = _query;
this._args = _args;
...
_c.Formatter /*japam.sie.b4xformatter*/ ._formatlabel /*String*/ (_rs.GetDouble(_c.SQLID /*String*/ ),_lbl);
 if (true) break;
...
parent.__c.LogImpl("915990854",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
;
...
_c = (japam.sie.b4xtable._b4xtablecolumn)(_visiblecolumns.Get(_i));
...
public String  _removecolumnfromclv(japam.sie.b4xtable._b4xtablecolumn _c) throws Exception{
int _i = 0;
...
if ((_c).equals((japam.sie.b4xtable._b4xtablecolumn)(_clvdata._getvalue(_clvindex))) == false) { 
...
public String  _resizecolumnimpl(japam.sie.b4xtable._b4xtablecolumn _c,int _totalheight) throws Exception{
float _height = 0f;
int _topint = 0;
int _heightint = 0;
int _i = 0;
...
public ResumableSub_SearchField_TextChanged(japam.sie.b4xtable parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
public ResumableSub_SetData(japam.sie.b4xtable parent,anywheresoftware.b4a.objects.collections.List _data) {
this.parent = parent;
this._data = _data;
}
japam.sie.b4xtable parent;
...
_textflow._reset /*japam.sie.b4jtextflow*/ ();
 //BA.debugLineNum = 523;BA.debugLine="If x > 0 Then";
if (_x>0) { 
 //BA.debugLineNum = 524;BA.debugLine="TextFlow.Append(Text.SubString2(0, x)).SetColo";
_textflow._append /*japam.sie.b4jtextflow*/ (_text.substring((int) (0),_x))._setcolor /*japam.sie.b4jtextflow*/ (_textcolor)._setfont /*japam.sie.b4jtextflow*/ ((anywheresoftware.b4j.objects.JFX.FontWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.JFX.FontWrapper(), (javafx.scene.text.Font)(_labelsfont.getObject())));
 };
 //BA.debugLineNum = 526;BA.debugLine="TextFlow.Append(Text.SubString2(x, x + FilterTe";
_textflow._append /*japam.sie.b4jtextflow*/ (_text.substring(_x,(int) (_x+_filtertext.length())))._setcolor /*japam.sie.b4jtextflow*/ (_highlighttextcolor)._setfont /*japam.sie.b4jtextflow*/ ((anywheresoftware.b4j.objects.JFX.FontWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.JFX.FontWrapper(), (javafx.scene.text.Font)(_labelsfont.getObject())));
...
_textflow._append /*japam.sie.b4jtextflow*/ (_text.substring((int) (_x+_filtertext.length())))._setcolor /*japam.sie.b4jtextflow*/ (_textcolor)._setfont /*japam.sie.b4jtextflow*/ ((anywheresoftware.b4j.objects.JFX.FontWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.JFX.FontWrapper(), (javafx.scene.text.Font)(_labelsfont.getObject())));
 };
...
public ResumableSub_UpdateSearchFieldVisibility(japam.sie.b4xtable parent) {
this.parent = parent;
}
japam.sie.b4xtable parent;
