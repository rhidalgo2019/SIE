...
public class b4xswitch extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xswitch", this);
            if (htSubs == null) {
...
public ResumableSub_SetValueImpl(japam.sie.b4xswitch parent,boolean _b,boolean _immediate) {
this.parent = parent;
this._b = _b;
