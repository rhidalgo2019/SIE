...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xfloattextfield", this);
            if (htSubs == null) {
...
__c.LogImpl("928311576","Multiline not supported with password mode.",0);
 };
...
public japam.sie.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((japam.sie.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(japam.sie.b4xfloattextfield _field) throws Exception{
Object _o = null;
...
_mnexttextfield = (japam.sie.b4xfloattextfield)(_o);
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((japam.sie.b4xfloattextfield)(this)) == false) { 
