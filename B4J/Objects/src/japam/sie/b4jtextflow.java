...
public class b4jtextflow extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4jtextflow", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", japam.sie.b4jtextflow.class).invoke(this, new Object[] {null});
        else
...
public japam.sie.b4jtextflow  _append(String _text) throws Exception{
...
if (true) return (japam.sie.b4jtextflow)(this);
...
public japam.sie.b4jtextflow  _reset() throws Exception{
...
public japam.sie.b4jtextflow  _setcolor(int _color) throws Exception{
...
public japam.sie.b4jtextflow  _setfont(anywheresoftware.b4j.objects.JFX.FontWrapper _font) throws Exception{
...
public japam.sie.b4jtextflow  _setstrikethrough(boolean _strikethrough) throws Exception{
...
public japam.sie.b4jtextflow  _setunderline(boolean _underline) throws Exception{
