...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xbytesbuilder", this);
            if (htSubs == null) {
...
public japam.sie.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public japam.sie.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (_index>_mlength) { 
__c.LogImpl("97929858","Index too large",0);};
...
if (_index>_mlength) { 
__c.LogImpl("97995394","Index too large",0);};
