...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xdatetemplate", this);
            if (htSubs == null) {
...
public ResumableSub_Show(japam.sie.b4xdatetemplate parent,japam.sie.b4xdialog _dialog) {
this.parent = parent;
