...
public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("japam.sie", "japam.sie.b4xpages", null);
		ba.loadHtSubs(b4xpages.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "japam.sie.b4xpages", ba);
		}
	}
...
public static japam.sie.b4xpagesmanager  _getmanager() throws Exception{
...
if (true) return _getmanager()._findpifromb4xpage /*japam.sie.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Parent /*japam.sie.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ ;
...
if (true) return _getmanager()._findpifromb4xpage /*japam.sie.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Id /*String*/ ;
...
public static japam.sie.b4xmainpage  _mainpage() throws Exception{
...
if (true) return _getmanager()._mainpage /*japam.sie.b4xmainpage*/ ;
...
_delegate = new japam.sie.b4xpagesdelegator();
