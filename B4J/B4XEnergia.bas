...
Private Sub B4XPage_Created (Root1 As B4XView)
	...
	TBL_Energia.ColsWidth=Array As Int(130dip, 400dip, 130dip, 130dip)
	...
	TBL_Energia.ColsAlignment=Array As String("CENTER", "CENTER", "CENTER", "CENTER")
...
Sub Cargar_Valores ()
	...
	If Main.mSQL.IsInitialized Then
		...
		Do While mRS.NextRow
			...
			End Select
			If mGASTOS(Main.mULT_EXTRAIDO) = "" Then
				mGASTOS(Main.mULT_EXTRAIDO) = "0"
			End If
			If mCONSUMOS(Main.mULT_EXTRAIDO) = "" Then
				mCONSUMOS(Main.mULT_EXTRAIDO) = "0"
			End If
		Loop
